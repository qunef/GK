...
<body>
    ...
    <section id="hero" class="hero">
        <div class="hero-content">
            ...
            <div class="hero-text">
                <h1>Giat Kedinasan - Program Persiapan Seleksi Sekolah Kedinasan Terbaik</h1>
    ...
    <section class="testimonials">
        <div class="container">
            ...
            <p class="testimonial-text">Berikut Testimoni Alumni yang berhasil meraih mimpinya lolos ke berbagai sekolah kedinasan</p>
        </div>
