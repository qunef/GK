{{-- Ganti semua isi navigation.blade.php dengan ini --}}
<nav x-data="{ open: false }" class="header" style="position: relative; height: auto; min-height: 4.5rem;">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        {{-- Hapus class warna bawaan, kita akan style dari CSS --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden responsive-nav-links">
